...
import org.apache.ibatis.reflection.typeparam.ClassA;
import org.apache.ibatis.reflection.typeparam.ClassA.SubClassA;
...
//    Field field = declaredClass.getDeclaredField("fld");
    Field field = declaredClass.getDeclaredField("map");
...
//    assertEquals(String.class, result);
  ...
  @Test
  void testFile_GenericField_2() throws Exception {
    Field field = ClassA.class.getDeclaredField("map");
    Type type = TypeParameterResolver.resolveFieldType(field, TypeParameterResolverTest.class.getDeclaredField("sa").getGenericType());
  }
